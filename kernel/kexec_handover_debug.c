...
static __init void __kho_in_debugfs_init(const void *fdt)
{
...
static int __kho_out_debugfs_init(void)
{
...
static __init int __kho_debugfs_init(void)
{
...
__ref void kho_in_debugfs_init(const void *fdt)
{
	__kho_in_debugfs_init(fdt);
}

__ref int kho_out_debugfs_init(void)
{
	return __kho_out_debugfs_init();
}

__ref int kho_debugfs_init(void)
{
	return __kho_debugfs_init();
}
