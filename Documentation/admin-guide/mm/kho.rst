...
their own preserved memory regions under
``/sys/kernel/debug/kho/out/fdt_folios/``.
...
``/sys/kernel/debug/kho/out/fdt_folios/``
    ...
    preserved FDT blob under this directory.
...
``/sys/kernel/debug/kho/in/fdt_folios/``
  Similar to ``kho/out/fdt_folios/``, but contains preserved FDT blobs
