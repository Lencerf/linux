 ...
 *                      phase.
 * @LIVEUPDATE_FREEZE:  Sent from the reboot() syscall, when the old kernel is
 ...
 *                      state.
 * @LIVEUPDATE_CANCEL:  Sent if the LIVEUPDATE_PREPARE or LIVEUPDATE_FREEZE
 ...
 * @freeze:       Optional. Called during LUO freeze event phase (before
